	...
	_particlePositionInputBuffers(inputBuffers)
{
	...
	VkShaderModule initializationShaderModule = CreateShaderModule(VulkanCore::Get()->GetLogicalDevice(), ReadFile(L"Shaders/Presentation/MarchingCubesInitialization.spv"));
